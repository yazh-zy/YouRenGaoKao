package com.yangzhou.diplomaproject.view;
...
public class CommonDialog extends Dialog
{
	...
	public CommonDialog(Context context, String titleMsg, String contentMsg, String confirmText,
						DialogClickListener confirmListener)
	{
		this(context, titleMsg, contentMsg, confirmText, null, Util.dip2px(context, 260), confirmListener, null);
	}
	...
	{
		this(context, msg, contentMsg, confirmText, cancelText, Util.dip2px(context, 260), confirmClick, null);
	}
