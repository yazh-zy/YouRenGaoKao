package com.yangzhou.diplomaproject.update;
...
public class UpdateService extends Service {
    ...
    private void notifyThatExceedLv21(String tickerMsg, String message, int progress) {
        ...
        notification.setSmallIcon(R.drawable.nopic);
        notification.setLargeIcon(BitmapFactory.decodeResource(getResources(), R.drawable.nopic));
